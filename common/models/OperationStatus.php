...
/**
 * This is the model class for table "operationstatus".
 *
 ...
 */
class OperationStatus extends ActiveRecord
{
    ...
    {
        return $this->hasOne(OperationStatus::className(), ['uuid' => 'operationStatusUuid']);
    }
}
