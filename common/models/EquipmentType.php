...
class EquipmentType extends ActiveRecord
{
    ...
    const EQUIPMENT_BASEMENT_DOOR = 'EDBE2840-12D3-4182-AFC1-072A1CEFB44E';

    const EQUIPMENT_FIREGUARD_BOX = 'F01A8C85-D51A-4DCE-BF0C-C31013AE5D16';
    const EQUIPMENT_FIREGUARD_BUTTON = 'D1094FC1-4E29-4332-B3F9-F1583E26AEE6';
    const EQUIPMENT_FIREGUARD_ALARM = '68DFADF9-A67F-4C1B-8B28-ADAC8ED59359';
    const EQUIPMENT_FIREGUARD_SENSOR = 'DC933785-5B66-456B-A583-5150F422A7F2';
