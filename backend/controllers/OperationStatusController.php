...
use backend\models\OperationSearchStatus;
...
class OperationStatusController extends Controller
{
    ...
    {
        $searchModel = new OperationSearchStatus();
    ...
    /**
     * Displays a single OperationStatus model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing OperationStatus model.
