...
use backend\models\FlatSearchType;
...
/**
 * FlatTypeController implements the CRUD actions for FlatType model.
 */
class FlatTypeController extends Controller
{
    ...
    {
        $searchModel = new FlatSearchType();
     ...
     * @param integer $id
     * @return FlatType the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = FlatType::findOne($id)) !== null) {
            return $model;
        } else {
