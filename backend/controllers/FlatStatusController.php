 ...
 */
class FlatStatusController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new FlatSearchStatus();
     ...
     * @param integer $id
     * @return FlatStatus the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = FlatStatus::findOne($id)) !== null) {
            return $model;
        } else {
