 ...
 * @link     http://www.toirus.ru
 */
class RepairPartSearch extends RepairPart
{
    /**
     * Rules
     *
    ...
    public function rules()
    {
        return [
            [['_id'], 'integer'],
            [
                ['uuid', 'title', 'repairPartTypeUuid', 'createdAt', 'changedAt'],
                'safe'
            ],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'uuid', $this->uuid])
            ...
            ->andFilterWhere(
                ['like', 'repairPartTypeUuid', $this->repairPartTypeUuid]
            );
