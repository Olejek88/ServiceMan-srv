        ...
        if ($user->save()) {
            ...
            if ($organization->save()) {
                ...
                if ($users->save()) {
                    ...
                    ReferenceFunctions::loadReferences($organization->uuid, Yii::$app);
                    ReferenceFunctions::loadReferencesNext($organization->uuid, Yii::$app);
                    ReferenceFunctions::loadReferencesAll($organization->uuid, Yii::$app);
                    return $user;
                } else {
                    $user->delete();
                    $organization->delete();
