<?php
/* @var $searchModel backend\models\DefectSearchType */

use yii\helpers\Html;
use yii\grid\GridView;

$this->title = Yii::t('app', 'Категории дефектов');
?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading" style="background: #fff;">
            ...
            <ul class="nav nav-tabs" style="width: 203px; margin: 0 auto;">
                <li class=""><a href="/defect">Список</a></li>
                <li class="active"><a href="/defect-type">Тип</a></li>
            </ul>
        </div>
