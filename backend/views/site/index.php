...
<div class="box-relative">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <form class="navbar-form navbar-left" role="search">
                        <div class="form-group">
                            <input type="text" class="form-control search-model" id="autofocus-none" placeholder="Поиск" style="width: 280px;" disabled="disabled">
                        </div>
    ...
    <div class="control-panel-user-tool">
        <div class="btn-group btn-group-justified">
            <a href="#" class="btn btn-default dropdown-toggle sync" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Журнал событий">Журнал</a>
                            ...
                            <form class="form-horizontal">
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php if (isset($accountUser->email)): ?>
                                                <input type="text" class="form-control" id="inputEmail" value="<?= Html::encode($accountUser->email) ?>">
                                            <?php else: ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php if (isset($accountUser->username)): ?>
                                                <input type="text" class="form-control" id="inputEmail" value="<?= Html::encode($accountUser->username) ?>">
                                            <?php else: ?>
                                                <input type="text" class="form-control" id="inputEmail">
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php if (isset($accountUser->created_at)): ?>
                                                <input type="text" class="form-control" id="inputEmail" value="<?= Html::encode(date("F j, Y, g:i a", $accountUser->created_at)) ?>">
                                            <?php else: ?>
                                                <input type="text" class="form-control" id="inputEmail">
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="form-group text-center">
                                        <div class="col-lg-12">
                                            <?php if (isset($accountUser->created_at)): ?>
                                                <a href="/user/update?id=<?= Html::encode(Yii::$app->user->identity->attributes['id']) ?>" class="btn btn-primary">
                                                    Изменить
                                                </a>
                                            <?php else: ?>
                                                <a href="#">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <input type="text" class="form-control" id="order-filtr-input" v-model="input" placeholder="Введите ключые слова для фильтрации" autofocus>
                    </div>
                        ...
                        <ul class="list-group" v-for="item in orders | orderBy 'changedAt' -1 | filterBy input">
                            <a href="/orders/{{ item._id }}">
                                <div class="info-box bg-aqua">
                                    <span class="info-box-icon" style="background: #ccc; height: 106px;"><i class="fa fa-cogs"></i></span>
                        ...
                        <ul class="list-group" v-for="item in equipment | orderBy 'changedAt' -1 | filterBy input">
                            <a href="/equipment/view?id={{ item._id }}">
                                <div class="info-box bg-green" style="background: #708090;">
                                    <span class="info-box-icon" style="height: 105px; width: 105px; background-image: url(<?= "{{ item.image }}" ?>); display: inline-block; background-size: 100px; background-repeat: no-repeat;">
<!--                                        <img src="{{ item.image }}" alt="Images" style="height: 105px; width: 100px;">-->
    ...
    <div class="close-panel-list" style="position: absolute; z-index: 2100; bottom: 50px; width: 900px; left: 50%; margin-left: -450px;">
                        ...
                        <footer class="panel-last-event" style="margin: 0;">
                            <div class="block-table-journal table-responsive">
                                <div class="DivFixTable">
                                	<div class="Tdata">
                                		<table id="MyTable" class="table table-bordered table-hover table-condensed all-tables">
                                			<col width=10> <col width=60> <col width=80> <col width=200>
