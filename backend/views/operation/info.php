...
/* @var $status common\models\OperationStatus */
/* @var $verdict common\models\OperationVerdict */
...
$this->params['breadcrumbs'][] = [
    'label' => Yii::t('app', 'Этап №' . $model->taskStage['_id']),
    'url' => ['/stage/info?id=' . $model->taskStage['_id']]];
?>
                        ...
                        <?php echo DetailView::widget(
                            [
                                ...
                                'attributes' => [
                                    ...
                                    [
                                        'label' => 'Статус',
                                        'value' => $model->operationStatus['title']
                                    ],
                                    [
                                        'label' => 'Вердикт',
                                        'value' => $model->operationVerdict['title']
                                    ],
                                    [
                                        'label' => 'Создан',
