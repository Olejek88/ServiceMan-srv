...
/* @var $searchModel backend\models\StageSearchTemplate */

$this->title = Yii::t('app', 'Шаблоны этапов');
?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading" style="background: #fff;">
            ...
            <ul class="nav nav-tabs" style="width:403px; margin: 0 auto;">
                ...
                <li class=""><a href="/stage-type">Тип</a></li>
                <li class=""><a href="/stage-status">Статусы</a></li>
                <li class=""><a href="/stage-verdict">Вердикты</a></li>
                <li class="active"><a href="/stage-template">Шаблоны</a></li>
            </ul>
        </div>
