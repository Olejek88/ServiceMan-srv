...
/*    echo $form->field($taskTemplate, 'stageTemplateUuid')
        ...
        ->label(false);*/
    echo $form->field($taskTemplate, 'oid')->hiddenInput(['value' => Users::ORGANISATION_UUID])->label(false);
    echo $form->field($taskTemplateEquipment, 'oid')->hiddenInput(['value' => Users::ORGANISATION_UUID])->label(false);
