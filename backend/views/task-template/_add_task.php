...
/*    echo $form->field($taskTemplate, 'stageTemplateUuid')
        ...
        ->label(false);*/
    echo $form->field($taskTemplate, 'oid')->hiddenInput(['value' => Users::getOid(Yii::$app->user)])->label(false);
    echo $form->field($taskTemplateEquipment, 'oid')->hiddenInput(['value' => Users::getOid(Yii::$app->user)])->label(false);
