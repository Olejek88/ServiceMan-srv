...
/* @var $searchModel backend\models\UsersAttributeSearch */

$this->title = Yii::t('app', 'Аттрибуты пользователей');
?>
<div class="equipment-index box-padding-index">
    ...
    <div class="panel panel-default">
        <div class="panel-heading" style="background: #fff;">
            ...
            <ul class="nav nav-tabs" style="width: 445px; margin: 0 auto;">
                <li class=""><a href="/users">Пользователи</a></li>
                <li class=""><a href="/attribute-type">Типы аттрибута</a></li>
                <li class="active"><a href="/users-attribute">Аттрибуты пользователей</a></li>
            </ul>
        </div>
