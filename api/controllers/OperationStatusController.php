 ...
 * @link     http://www.toirus.ru
 */
class OperationStatusController extends ActiveController
{
    public $modelClass = 'app\models\OperationStatus';
    ...
    public function actionIndex()
    {
        ...
        $operationUuid = $req->getQueryParam('operationUuid');
        if ($operationUuid != null) {
            $query->andWhere(['operationUuid' => $operationUuid]);
        }
